...
<details>
  ...
  <h3>swagger-ui</h3>
  <IMG src="./res/api_agegender_docs.jpg"  alt="swagger documentation"/>
  <h3>redoc</h3>
  <IMG src="./res/api_agegender_redoc.jpg"  alt="swagger documentation"/>
</details>
...
As an example, the configuration for the [AgeGender](/toolbox/Projects/AgeGender/) Project could look like this:
